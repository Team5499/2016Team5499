...
public class AutoModeSequences {
	...
	public AutoModeSequences(){
		...
		modes.get("low bar goal").addLast(new Command(Command.commandType.CMD_AFLIP, 0, 0, 0, true, true, Commands.ShotRequest.OFF, 0, 0, Commands.ShiftRequest.HIGH, 2));
		modes.get("low bar goal").addLast(new Command(Command.commandType.CMD_DRIVE, 15, 15, 0, true, true, Commands.ShotRequest.OFF, 0, 0, Commands.ShiftRequest.HIGH, 5));
		modes.get("low bar goal").addLast(new Command(Command.commandType.CMD_DRIVE, 15, 15, 30, true, true, Commands.ShotRequest.OFF, 0, 0, Commands.ShiftRequest.HIGH, 3));
		modes.get("low bar goal").addLast(new Command(Command.commandType.CMD_CHANGE_SHOT, 15, 15, 30, true, true, Commands.ShotRequest.AUTO, 5200, 5000, Commands.ShiftRequest.HIGH, 3));
		modes.get("low bar goal").addLast(new Command(Command.commandType.CMD_SHOOT, 15, 15, 30, true, true, Commands.ShotRequest.AUTO, 5200, 5000, Commands.ShiftRequest.HIGH, 1));
