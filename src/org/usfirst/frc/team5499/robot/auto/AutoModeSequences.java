...
public class AutoModeSequences {
	...
	public AutoModeSequences(){
		...
		modes.get("1 ball").addLast(new Command(Command.commandType.CMD_DRIVE, -14.65, -14.65, 0, true, true, Commands.ShotRequest.OFF, 0, 0, Commands.ShiftRequest.HIGH, 6, IntakeRollerState.OFF));
		...
		modes.get("1 ball").addLast(new Command(Command.commandType.CMD_DRIVE, -7, -7, 52, true, true, Commands.ShotRequest.OFF, 0, 0, Commands.ShiftRequest.HIGH, 4, IntakeRollerState.OFF));
		modes.get("1 ball").addLast(new Command(Command.commandType.CMD_CHANGE_SHOT, -8, -8, 0, true, true, Commands.ShotRequest.CLEAT, 5200, 5000, Commands.ShiftRequest.HIGH, 1, IntakeRollerState.OFF));
